...
1. [Create a fork](https://help.github.com/articles/fork-a-repo) of the upstream
   repository at [`pseudopotential-tools/oncvpsp-tools`](https://github.com/pseudopotential-tools/oncvpsp-tools)
   on your GitHub account (or in one of your organizations)
2. [Clone your fork](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
   with `git clone https://github.com/<your namespace here>/oncvpsp-tools.git`
...
```shell
$ git remote add pseudopotential-tools https://github.com/pseudopotential-tools/oncvpsp-tools.git
```
